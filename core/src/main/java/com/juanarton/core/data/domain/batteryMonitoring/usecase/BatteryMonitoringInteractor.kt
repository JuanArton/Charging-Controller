...
class BatteryMonitoringInteractor @Inject constructor(
    ...
    override fun insertLastUnpPlugged(lastUnplugged: Long, lastUnpluggedLevel: Int) {
        iBatteryMonitoringRepository.insertLastUnplugged(lastUnplugged, lastUnpluggedLevel)
    }
    ...
    override fun getDataByRange(startTime: Long, endTime: Long): Flow<List<BatteryHistory>> =
        iBatteryMonitoringRepository.getDataByRange(startTime, endTime)
}